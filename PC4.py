...
if pagina_seleccionada == 'Inicio':
    ...
    col1.image("tlou.jpg", caption='Ellie', width=300)
    ...
    st.markdown("<h2 style='text-align: center;'>Presentación de videos</h2>", unsafe_allow_html=True)
    ...
    graficos = ['Gráfico de barras verticales de lenguas aisladas', 'Gráfico de barras horizontales de familias lingüísticas', 'mapa cusco']
